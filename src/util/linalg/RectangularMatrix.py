...
#*/
	 ...
	 * @return the matrix
	 */
	 static RectangularMatrix eye(int m):
		return eye(m, m)
	}
	 ...
	 * @return the matrix
	 */
	 static RectangularMatrix eye(int m, int n):
	 ...
	 * @return the matrix
	 */
	 static RectangularMatrix diag(Matrix[] matrices):
		int m = 0, n = 0
...
#* @return the matrix
#*/
     static RectangularMatrix ones(int m):
        return ones(m, m)
    }
...
#* @return the matrix
#*/
     static RectangularMatrix ones(int m, int n):
        double[][] result = new double[m][n]
...
#*/
     static RectangularMatrix random(int m):
        return random(m, m)
    }
...
#* @return the random matrix
#*/
     static RectangularMatrix random(int m, int n):
...
#*/
     static Matrix columns(Vector[] columns):
...
#*/
     static Matrix rows(Vector[] rows):
