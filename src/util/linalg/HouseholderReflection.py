...
#*/
     HouseholderReflection(Vector v, double beta):
        self.v = v
        self.beta = beta
    }
...
#*/
     HouseholderReflection(Vector x):
...
#*/
      applyLeft(Matrix m, int ia, int ib, int ja, int jb):
...
#* @param jb the ending column
#*/
      applyRight(Matrix m, int ia, int ib, int ja, int jb):
