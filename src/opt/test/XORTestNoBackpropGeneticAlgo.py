...
#/**
#* Based on the XORTest test class, self class uses a standard FeedForwardNetwork
...
#* @date 2013-03-05
#*/
 class XORTestNoBackpropGeneticAlgo {
...
#*/
     static  main(String[] args):
        ...
        // 7) Instantiate a trainer.  The FixtIterationTrainer takes another trainer (in self case,
        ...
        //    optimal weights found for self network.
