...
#* @version 1.0
#*/
 class TravelingSalesmanCrossOver (CrossoverFunction):
...
#*/
     TravelingSalesmanCrossOver(TravelingSalesmanEvaluationFunction eval):
        self.eval = eval
    }
...
#*/
     Instance mate(Instance a, Instance b):
