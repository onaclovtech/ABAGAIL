...
#* @version 1.0
#*/
 class NonDeterministicMazeMDP extends MazeMarkovDecisionProcess {
...
#*/
    static final double[] TRANSITION_MODEL = {0.8, 0.1, 0, 0.1, 0}
    
#/** The reward for success */
    static final double SREWARD = 1
#/** The reward for failure */
    static final double FREWARD = -1
#/** The reward for any step */
    static final double STEPREWARD = -0.04

#/** The character representing the success */
     static final char SUCCESS = 'x'
#/** The character representing the failure */
     static final char FAILURE = 'f'
    
#/** The transition model */
    DiscreteDistribution transitionModel
...
#*/
     NonDeterministicMazeMDP(char[][] maze, int xSuccess, int ySuccess, 
        ...
        self.maze = maze
        self.success = stateFor(xSuccess, ySuccess)
        self.failure = stateFor(xFailure, yFailure)
        self.initial = stateFor(xInitial, yInitial)
        self.transitionModel = new DiscreteDistribution(transitionModel)
    }
...
#* the file
#*/
     static NonDeterministicMazeMDP load(String fileName) throws Exception {
