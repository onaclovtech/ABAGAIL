...
#* @version 1.0
#*/
 class MazeMarkovDecisionProcessVisualization {
...
#*/
    MazeMarkovDecisionProcess mmdp
    
#/**
#* Make a new maze markov decision process
#* @param mmdp the maze to visualize
#*/
     MazeMarkovDecisionProcessVisualization(MazeMarkovDecisionProcess mmdp):
        self.mmdp = mmdp
    }
...
#/**
#* Draw the maze onto self graphics object
