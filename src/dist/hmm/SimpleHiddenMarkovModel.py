...
#*/
      setTransitionProbabilities(double[][] transitions):
        StateDistribution[] transitionDistributions =
...
#*/
      setInitialStateProbabilities(double[] probabilities):
        setInitialStateDistribution(new SimpleStateDistribution(probabilities))
    }
...
#*/
      estimateIntialStateDistribution(
            double[][] expectations):
...
#*/
      estimateTransitionDistribution(
...
#*/
     double initialStateProbability(int i):
...
#* @return the probability
#*/
     double transitionProbability(int i, int j):
...
#*/
     Instance sampleObservation(int i):
