...
#/**
#* The [t][i] entry of self matrix represents
...
#* probabilities.  Through self matrix the chain
...
#*/
     StateSequenceCalculator(HiddenMarkovModel model, 
            DataSet observations):
       self.model = model
