...
#* @version 1.0
#*/
 class HiddenMarkovModelReestimator (Trainer):
...
#*/
     HiddenMarkovModelReestimator(HiddenMarkovModel model,
            DataSet[] observationSequences):
        self.model = model
...
#*/
     double[][][] calculateTransitionExpectations(
...
#*/
     double[][] calculateStateExpectations(
            DataSet observationSequence, double[][] forwardProbabilities,
            double[][] backwardProbabilities):
...
#*/
      setModel(HiddenMarkovModel model):
        self.model = model
    }
}
