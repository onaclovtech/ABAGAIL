...
#*/
     abstract double p(int nextState, Instance observ)
...
#*/
     abstract int generateRandomState(Instance o)
...
#*/ 
     abstract  estimate(double[][] expectations, DataSet sequence)
}