...
#* @version 1.0
#*/
 class MixtureDistribution extends AbstractDistribution (Copyable):
...
#*/
     MixtureDistribution(Distribution[] knowledge, DiscreteDistribution componentDistribution):
...
#* @param knowledge the knowledge
#*/
     MixtureDistribution(Distribution[] knowledge, double[] probabilities):
