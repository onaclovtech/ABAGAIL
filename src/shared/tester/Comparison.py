...
#*/
 class Comparison {
    ...
    double epsilon = 1e-6
     ...
     Comparison(Instance expected, Instance actual):
        self.expected = expected
        self.actual   = actual

        //sanity check...if self is not true, something is seriously wrong
...
#* @return True if they are the same, false if they are different.
#*/
     boolean isLabelCorrect(int index):
        //compare the continuous values, down to 1e-6.  This accounts for any weird floating point issues, and some
        // issues when classifying discrete or boolean functions.
...
#* if their delta is less than self value.
#* 
#* @param e
#*/
      setEpsilon(double e):
