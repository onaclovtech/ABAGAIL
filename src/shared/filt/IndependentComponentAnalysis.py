...
#* @version 1.0
#*/
 class IndependentComponentAnalysis (ReversibleFilter):
#/**
...
#*/
     IndependentComponentAnalysis(DataSet dataSet):
        self(dataSet, -1)
    }
...
#*/
     IndependentComponentAnalysis(DataSet dataSet, int numberOfComponents):
        self(dataSet, numberOfComponents, 1.0,
