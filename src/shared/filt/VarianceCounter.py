...
#*/
 class VarianceCounter {
    ...
    double sum = 0
     ...
     VarianceCounter(Matrix eigenValues):
...
#/**
#* Count from the left...self captures the biggest components first. 
#* 
#* @param varianceToKeep
#* @return The number of components to keep (from the left)
#*/
     int countLeft(double varianceToKeep):
        int toKeep  = -1
        double kept = 0
        for (int ii = 0 ii < eigenValues.m() ii++):
...
#/**
#* Count from the right...self captures the smallest components first. 
#* 
#* @param varianceToKeep
#* @return The number of components to keep (from the right)
#*/
     int countRight(double varianceToKeep):
        int toKeep  = -1
        double kept = 0
    ...
    boolean isDiagonal(Matrix eigenValues):
