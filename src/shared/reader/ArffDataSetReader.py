...
#* @date 2013-03-05
#*/
 class ArffDataSetReader extends DataSetReader {

	final String DATA_TAG = "@data"
	final String ATTRIBUTE_TAG = "@attribute"
	final int SPLIT_LIMIT = 3

	
	 ArffDataSetReader(String file):
		super(file)
	}
	 ...
	 * @throws IOException
	 */
	List<Map<String, Double>> processAttributes(BufferedReader in)
		throws IOException {
		...
		while (line != null && line.toLowerCase().indexOf(DATA_TAG) == -1):
			if (!line.isEmpty() && line.charAt(0) != '%'):
				...
				if (parts[0].equalsIgnoreCase(ATTRIBUTE_TAG)):
				    ...
				    //NOTE: for REAL and INTEGER types, self will do nothing but those types are handled
				    // in processInstances
	...
	Instance[] processInstances(BufferedReader in,
