...
#* @version 1.0
#*/
 class ChiSquarePruningCriteria extends PruningCriteria {
#/**
...
#*/
     ChiSquarePruningCriteria(int confidence):
...
#*/
     boolean shouldPrune(DecisionTreeSplitStatistics stats):
