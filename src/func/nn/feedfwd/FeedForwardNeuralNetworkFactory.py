...
#* @date 2013-03-05
#*/
 class FeedForwardNeuralNetworkFactory {
...
#/**
	 ...
	 */
    FeedForwardNetwork createNetwork(int[] nodeCounts,
...
#/**
	 ...
	 * @return a multilayer perceptron with nodeCounts.length layers
	 */
     FeedForwardNetwork createRegressionNetwork(int[] nodeCounts,
...
#/**
	 ...
	 * @return a multilayer perceptron with nodeCounts.length layers
	 */
     FeedForwardNetwork createClassificationNetwork(int[] nodeCounts,
           DifferentiableActivationFunction transfer):
...
#/**
	 ...
	 */
     ...
     int getOptimalHiddenLayerNodes(DataSetDescription desc, DataSetDescription labelDesc):
