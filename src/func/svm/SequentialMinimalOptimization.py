...
#* @version 1.0
#*/
 class SequentialMinimalOptimization (Trainer):
#/**
#* The tolerance value
#*/
...
#*/
     SequentialMinimalOptimization(DataSet examples,
...
#*/
     SupportVectorMachine getSupportVectorMachine():
...
#*/
    final boolean takeStep(int i, int j, double ej):
