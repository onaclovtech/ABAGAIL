...
#* @version 1.0
#*/
 class SingleClassSequentialMinimalOptimization (Trainer):
...
#*/
     SingleClassSequentialMinimalOptimization(DataSet examples,
...
#*/
     double train():
        // number of alpha values changed self iteration
        int numChanged = 0
...
#*/
     SingleClassSupportVectorMachine getSupportVectorMachine():
...
#*/
    final boolean takeStep(int i, int j, double oj):
