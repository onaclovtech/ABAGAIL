...
#*/
     KDTree(DataSet keys, DistanceMeasure distance):
...
#*/
     KDTree(DataSet keys):
        self(keys, new EuclideanDistance())
    }
...
#*/
    KDTreeNode buildTree(KDTreeNode[] nodes, int start, int end):
        if (start >= end):
...
#*/
    int partition(Comparable[] comparables, int start, int end, 
            int splitterIndex):
...
#*/
     swap(Object[] objects, int i, int j):
...
#* @return the splitter
#*/
    int chooseSplitterRandom(KDTreeNode[] nodes, int start, int end):
...
#*/
    int chooseSplitterSmart(KDTreeNode[] nodes, int start, int end):
...
#*/
     Instance[] knn(Instance target, int k):
...
#*/
     Instance[] range(Instance target, double range):
...
#*/
     Instance[] knnrange(Instance target, int k, double range):
...
#*/
     knn(KDTreeNode node, Instance target, HyperRectangle hr,  
